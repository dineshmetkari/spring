...
public class Application {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("com/example/spring/five/springConfig.xml");
		...
		student.greeting("Greeting from Spring using inner beans!");
